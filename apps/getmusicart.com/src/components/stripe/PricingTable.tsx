...
export default function StripePricingTable({ user }: { user: User }) {
  useEffect(() => {
  ...
  if (pricingTableId === undefined || publishableKey === undefined) {
    return (
      <div className="flex flex-1 flex-col w-full">
        <h1 className="text-5xl tracking-tighter pb-10 font-bold">no pricing table id or publishable key provided</h1>
      </div>
    );
  }
