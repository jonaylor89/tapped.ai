		...
		<footer id="footer" className="">
			<div className="mx-auto w-full max-w-screen-xl">
				<div className="grid grid-cols-2 gap-8 px-4 py-6 md:grid-cols-4 lg:py-8">
					<div>
						<h2 className="mb-6 font-semibold text-gray-700 text-sm uppercase dark:text-white">
							company
						</h2>
				...
				<div className="px-4 py-6 md:flex md:items-center md:justify-between">
					<span className="text-gray-600 text-sm sm:text-center dark:text-foreground/50">
						© {new Date().getFullYear()}.{" "}
						<Link href="https://tapped.ai/">Tapped Industries Inc.™</Link>. All Rights Reserved. -
