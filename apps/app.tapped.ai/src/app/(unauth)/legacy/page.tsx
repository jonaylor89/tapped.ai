		...
		<div className="flex min-h-screen flex-col">
			...
			<header className="bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900 px-4 py-24 md:px-6 lg:px-8">
				<div className="container mx-auto max-w-6xl">
					<div className="flex flex-col items-center text-center">
						<h1 className="mb-6 font-bold text-4xl text-white tracking-tight md:text-6xl lg:text-7xl">
							Unlock the{" "}
						...
						<div className="space-y-2 font-medium text-2xl text-white tracking-tight md:text-3xl lg:text-4xl">
							<p>
								-build your <span className="text-purple-400 italic">community</span>.
							</p>
							<p>
								-connect with <span className="font-bold text-blue-400">superfans</span>.
							</p>
							<p>
								-sell out <span className="text-purple-400 italic">your events</span>.
							</p>
						</div>
			...
			<section className="px-4 py-20 md:px-6 lg:px-8">
				<div className="container mx-auto max-w-4xl text-center">
					<p className="font-medium text-slate-700 text-xl italic leading-relaxed md:text-2xl dark:text-slate-300">
						&quot;Tapped Ai connects performers with the right venues, superfans, and opportunities
						to grow their careers. Whether you&apos;re an artist, organizer, or fan, we make live
						music smarter, easier, and more impactful.&quot;
					</p>
				</div>
			</section>
			...
			<section className="bg-white px-4 py-20 md:px-6 lg:px-8 dark:bg-slate-800">
				<div className="container mx-auto max-w-5xl">
					<div className="text-center">
						...
						<p className="mx-auto max-w-3xl text-lg text-slate-700 leading-relaxed dark:text-slate-300">
							tapped premium gives you insider access to the tools, data, and opportunities reserved
							for the top 1% of artists ready to take over the live events world.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="bg-gradient-to-r from-purple-900 to-indigo-900 px-4 py-16 text-white md:px-6 lg:px-8">
				<div className="container mx-auto">
					<div className="grid grid-cols-1 gap-8 md:grid-cols-3">
						<div className="text-center">
							<h3 className="mb-2 font-bold text-4xl md:text-5xl lg:text-6xl">100k+</h3>
							<p className="font-semibold text-xl italic">performers</p>
						</div>
						<div className="text-center">
							<h3 className="mb-2 font-bold text-4xl md:text-5xl lg:text-6xl">35k+</h3>
							<p className="font-semibold text-xl italic">venues</p>
						</div>
						<div className="text-center">
							<h3 className="mb-2 font-bold text-4xl md:text-5xl lg:text-6xl">160k+</h3>
							<p className="font-semibold text-xl italic">bookings</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section className="px-4 py-20 md:px-6 lg:px-8">
				<div className="container mx-auto max-w-5xl">
					<h2 className="mb-12 text-center font-bold text-4xl tracking-tight md:text-5xl">
						get to know &quot;
						<span className="text-purple-600 dark:text-purple-400">tapped premium</span>
						&quot;.
					</h2>
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
						...
						<Card>
							...
							<CardContent>
								<p className="text-slate-600 italic dark:text-slate-400">
									Find out where superfans live, their favorite venues, and how to sell out every
									show.
								</p>
							</CardContent>
						</Card>
			...
			<section className="px-4 py-20 md:px-6 lg:px-8">
				...
				{/* Advisors Section */}
				<div className="container mx-auto max-w-5xl">
					<h2 className="mb-10 text-center font-bold text-4xl tracking-tight md:text-5xl">
						advisors
					</h2>

					<div className="mb-12 text-center">
						<p className="font-medium text-lg text-slate-700 dark:text-slate-300">
							our advisor network has been carefully crafted to be one degree away from everyone in
							the live events, music and tech industry.
						</p>
					</div>
			...
			<section className="bg-gradient-to-r from-purple-900 to-indigo-900 px-4 py-20 text-white md:px-6 lg:px-8">
				<div className="container mx-auto max-w-5xl text-center">
					<h2 className="mb-6 font-bold text-4xl tracking-tight md:text-5xl">
						&quot;<span className="text-purple-400">tapped mixer</span>&quot;
					</h2>
					<p className="mb-10 text-lg">
						a networking event to bring together a room of music, tech, and investors to connect and
			...
			<section className="px-4 py-20 md:px-6 lg:px-8">
				<div className="container mx-auto max-w-5xl">
					...
					<p className="text-center text-lg text-slate-700 italic dark:text-slate-300">
						find out how ilias and johannes tricked the music industry with an april fools prank to
						end up meeting the three biggest multi billion dollar corporations in the space.
					</p>
				</div>
				...
				<div className="container mx-auto max-w-4xl">
					...
					<div className="flex flex-col gap-4">
						<Card>
							...
							<CardContent>
								<p className="text-slate-700 dark:text-slate-300">
									Upgrading to Tapped AI Premium unlocks a suite of advanced features designed to
									significantly enhance your booking and touring capabilities. With Premium, you
									gain unlimited access to in-depth analytics, comprehensive data sets, and
									sophisticated booking tools that streamline the planning process. This
									subscription also provides exclusive insights into venue performance and audience
									preferences, allowing for more informed decision-making. Additionally, Premium
									users benefit from priority customer support and regular updates that include the
									latest industry trends and data enhancements, ensuring you have a competitive edge
						...
						<Card>
							...
							<CardContent>
								<p className="text-slate-700 dark:text-slate-300">
									The monthly subscription for performers cost $10 on desktop and $12.99 on app
									store.
								</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<p className="text-slate-700 dark:text-slate-300">
									Yes, you can cancel your subscription at any time. Upon cancellation, your
									subscription will remain active until the end of the current billing period. This
									means you&apos;ll still have access to the subscribed features until the end of
									your billing cycle, after which the subscription will terminate automatically.
								</p>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent>
								<p className="text-slate-700 dark:text-slate-300">
									Yes! We have a video from our founder Johannes Naylor that you can check if you
									scroll up or go to our youtube page here.
								</p>
							</CardContent>
						</Card>
					</div>
