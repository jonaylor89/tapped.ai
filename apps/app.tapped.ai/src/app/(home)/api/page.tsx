	...
	return (
		<>
			...
			<div className="flex flex-col gap-4 py-12">
				<h1 className="font-extrabold text-3xl text-gray-900 sm:text-4xl dark:text-gray-100">
				...
				<div className="flex flex-col gap-4 md:flex-row">
					<Card className="p-4">
						<h3 className="py-1 font-bold text-gray-900 text-lg dark:text-gray-100">
							extensive documentation
						</h3>
						<p>
							comprehensive guides and dedicated support ensure smooth api implementation and
							troubleshooting.
						</p>
					</Card>
					<Card className="p-4">
					...
					<Card className="p-4">
						...
						<p>
							api performance and request speed scale with your chosen pricing tier to match your
							business needs.
						</p>
					</Card>
				</div>
				<Card>
					<CardHeader>
						<h2 className="font-bold text-lg">live music data that scales</h2>
					</CardHeader>
