    ...
    >
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex" }}>
                <p style={{ fontSize: "36px", fontFamily: "JosefinSansBold", margin: "4px", marginBottom: "18px" }}>
                  Location
                </p>
              </div>
              <div style={{ display: "flex" }}>
      ...
      >
        ...
        >
          ...
          >
            <h1 style={{ fontFamily: "JosefinSansBold", fontSize: "48px", margin: "4px", color: "black" }}>
              Top Songs
            </h1>
            <div style={{ display: "flex", flexDirection: "column", margin: "4px" }}>
              <div style={{ display: "flex", flexDirection: "row" }}>
                <div style={{ display: "flex" }}>
                  <p style={{ fontSize: "26px", fontFamily: "JosefinSans", margin: "4px" }}>
                    {notableSongs[0].title} |
                  </p>
                </div>
                <div style={{ display: "flex" }}>
                  <p style={{ fontSize: "24px", fontFamily: "JosefinSansItalic", margin: "4px" }}>
