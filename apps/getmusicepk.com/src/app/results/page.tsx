...
export default function Results() {
  ...
  const payload: EpkPayload = {
    ...
    tappedRating: user?.overallRating !== undefined && user?.overallRating !== null ? `${user?.overallRating}` : null,
  };
            ...
            <div className="flex flex-nowrap">
              {imageUrls.map(({ url }, index) => (
                <div
                  ...
                  className={`w-[256px] md:w-[400px] mr-6 my-6 inline-block rounded-xl ${
                    selectedTheme === index && "border-4 border-white"
                  }`}
                >
                  <Image
                    src={url}
