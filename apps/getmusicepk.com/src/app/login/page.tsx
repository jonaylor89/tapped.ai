  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen rounded-lg p-16">
      <div className="flex items-center justify-center pb-5">
        <Image src="/images/icon_1024.png" alt="Tapped_Logo" width={124} height={124} />
      </div>
      ...
      <form className="w-full max-w-sm" onSubmit={handleLogin}>
        ...
        <div className="flex flex-col gap-4">
          <button className="bg-blue-700 px-4 py-2 rounded-full text-white font-bold" type="submit">
            login
          </button>
