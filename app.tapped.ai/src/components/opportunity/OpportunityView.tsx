...
import { ArrowUpRight, Calendar, Check, Coins, Info, MapPin, Share } from "lucide-react";
			...
			<div className="flex flex-col gap-4 md:relative md:flex-row md:items-start md:justify-center md:px-12">
				...
				<div className="md:flex md:grow md:justify-start">
					<div className="px-6 py-4">
						<h1 className="font-extrabold text-4xl">{opportunity.title}</h1>
						<div className="h-4" />
						...
						<div className="h-2" />
						<div>
							<h3 className="font-bold text-md">booker</h3>
							<div className="h-2" />
						...
						<div className="h-2" />
						<div className="py-6">
							<h3 className="font-bold text-md">about event</h3>
							<div className="h-2" />
						...
						{location && (
							<div>
								<div>
									<h3 className="font-bold text-md">location</h3>
