...
export default function DownloadTheAppSection({ showIcon = true }: { showIcon?: boolean }) {
	return (
		<div className="flex flex-row">
			<div className="flex flex-col gap-4">
				<h2 className="font-bold text-2xl">download the tapped app for more</h2>
			...
			{showIcon && (
				<div className="hidden flex-0 lg:block">
