...
const EnhancedButton = ({
  ...
  return (
    <button onClick={onClick} className="bg-purple-300 text-gray-600 font-extrabold px-4 py-2 rounded-lg">
      Ai-enhance
    </button>
  );
};
  ...
  return (
    <div className="page flex h-full flex-col items-center justify-center">
      <div className="flex w-full flex-col items-start">
        <h1 className="mb-2 text-2xl font-bold text-white">what&apos;s your bio?</h1>
        <div className="flex flex-col h-full w-full items-center justify-center">
          ...
          >
            ...
            <div className="flex justify-end">
              <EnhancedButton loading={loading} enhanced={enhanced} onClick={handleAiEnhance} />
            </div>
          </div>
