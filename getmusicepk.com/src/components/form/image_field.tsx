  ...
  return (
    <div className="page flex h-full flex-col items-center justify-center">
      <div className="flex w-full flex-col items-start px-6">
        <h1 className="mb-2 text-2xl font-bold text-white">Upload your image:</h1>
        ...
        <div className="flex h-full w-full items-center justify-center">
          <label className="tapped_btn_rounded white_placeholder w-full appearance-none rounded px-4 py-2 leading-tight text-white focus:bg-white focus:text-black font-semibold focus:outline-none cursor-pointer">
            Choose Image
            <input
              type="file"
              accept="image/*"
