...
export default function MinimalistTheme({
  ...
  const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?size=${qrCodeDimensions}x${
    qrCodeDimensions
  }&bgcolor=010F16&color=cbd5e1&data=https://instagram.com/${instagramHandle}`;
  const ratingString =
    tappedRating === null || tappedRating === "" ? "Unranked on Tapped" : `${tappedRating} / 5 stars on Tapped `;
  return (
    <div
      style={{
        height: "100%",
    ...
    >
      <div
        style={{ display: "flex", flexDirection: "row", marginBottom: "25px", alignItems: "flex-start", width: "100%" }}
      >
        <div
          style={{
            display: "flex",
          ...
          <div style={{ display: "flex", flexDirection: "column", padding: "0 20px", color: "white" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "flex" }}>
                  <img
                    src={getURL("/location_pin_icon.png")}
                    alt="Location icon"
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            <div style={{ display: "flex" }}>
              <p style={{ fontSize: "20px", fontFamily: "ArimoItalic", margin: "4px" }}>
                {notableSongs[0].plays} plays
              </p>
            </div>
          </div>
          <div style={{ display: "flex", flexDirection: "row" }}>
        ...
        >
          {tiktokHandle !== undefined && tiktokHandle !== null && tiktokHandle !== "" ? (
            ...
            >
              ...
              />
              <p style={{ marginLeft: "20px", fontSize: "20px", fontFamily: "ArimoBold" }}>@{tiktokHandle}</p>
            </div>
          ) : null}
          ...
          {twitterHandle !== undefined && twitterHandle !== null && twitterHandle !== "" ? (
            ...
            >
              <img
                ...
                style={{ objectFit: "cover" }}
              />
              <p style={{ marginLeft: "20px", fontSize: "20px", fontFamily: "ArimoBold" }}>@{twitterHandle}</p>
            </div>
          ) : null}
        </div>
        <div
          ...
          {instagramHandle !== undefined && instagramHandle !== null && instagramHandle !== "" ? (
            ...
            >
              <img
                ...
                style={{ objectFit: "cover" }}
              />
              <p style={{ marginLeft: "20px", fontSize: "20px", fontFamily: "ArimoBold" }}>@{instagramHandle}</p>
            </div>
          ) : null}
        </div>
      ...
      >
        ...
        >
          ...
          <p style={{ textAlign: "left", fontSize: 16 }}>{bio}</p>
        </div>
      </div>
      <div
        style={{
      ...
      >
        <img src={qrCodeUrl} width={qrCodeDimensions} height={qrCodeDimensions} />
      </div>
    </div>
  );
}
